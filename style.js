...
oawApp.loadUnit = function(data,currentUnit,updateHash) {
  ...
  $.each(topicUnits, function(i, unit){
    ...
    topicUnitsHTML += '<li><a href="javascript:void(0)" class="oaw-button oaw-button_2 oaw-button_a oaw-js--loadUnit '+currentClass+'" data-unit-id="'+topicUnitID+'" data-unit-number="'+topicUnitNumber+'" data-unit-template="'+topicUnitTemplate+'"><span>'+topicUnitTitle+'</span></a></li>';
